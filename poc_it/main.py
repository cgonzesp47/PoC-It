...
async def main() -> None:
    ...
    try:
        ...
        from poc_it.generador_artefactos import (
        ...
        if resultado.modo == ModoGeneracion.COMPLETO:
            ...
            if not validar_endpoints_ast(endpoints_code):
                ...
                from poc_it.generador_artefactos import _llamar_modelo
...
"""
            ...
            from poc_it.generador_informes import generar_readme_final
