...
from poc_it.capacidades import (
    EvaluacionCapacidades,
    evaluar_capacidades,
)
from poc_it.generador_proyecto_base import generar_proyecto_base
from poc_it.generador_artefactos import generar_artefactos_para_bloque
from poc_it.materializador_archivos import materializar_proyecto
from poc_it.generador_informe_final import generar_informe_final
