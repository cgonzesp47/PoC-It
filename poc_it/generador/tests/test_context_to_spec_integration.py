...
# app/core/config.py, independientemente de lo que el usuario haya declarado. Estos tests
# verifican trazabilidad de señales *detectadas del usuario*, así que filtramos esa señal
